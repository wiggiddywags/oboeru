...
#ifndef OBOERU_SWIFT_H
#define OBOERU_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Oboeru",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class AVAudioPlayer;
SWIFT_CLASS("_TtC6Oboeru21AudioPlayerController")
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC6Oboeru18SketchCanvasNSView")
@interface SketchCanvasNSView : NSView
